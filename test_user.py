...
payload={
    "title": "Title of the collection-a",
...
# print(payload['movies'][0])
# print("before")
payload_1 = json.dumps(payload, indent=4)
# payload_1 = json.loads(payload)
# print(payload_1)
# print("after")
# print(payload_1)
# print(payload_1[5])
...
resp = requests.post("http://127.0.0.1:8000/collection/",data=payload_1)
# resp = requests.get("http://127.0.0.1:8000/collection/")
# resp = requests.get("http://127.0.0.1:8000/movies/")

# resp = requests.get("http://localhost:8000/collection/6546a105-d3c8-48c9-9e47-af715e1b5a22/")
#
print(resp.text)
